...
class TestTokenValidator:
    ...
    def setup_method(self):
        ...
        # Create token with expiration far in the future to avoid test failures
        future_time = datetime.utcnow() + timedelta(hours=24)  # 24 hours from now
        self.test_payload = {
            "sub": self.test_email,
            "role": "patient",
...
class TestTokenBlacklistDB:
    ...
    @patch('database.database.get_db')
